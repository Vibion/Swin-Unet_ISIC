...
if __name__ == "__main__":
    if not args.deterministic:
        ...
        cudnn.benchmark = False # 关闭获得稳定的结果，否则cudnn会对输入数据的大小格式进行优化
        cudnn.deterministic = True # deterministic设置为true，用于复现结果
    ...
    dataset_name = args.dataset # 'Synapse'
    dataset_config = {
        'ISIC': {
